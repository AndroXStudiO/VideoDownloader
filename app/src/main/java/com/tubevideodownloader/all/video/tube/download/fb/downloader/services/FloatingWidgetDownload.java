package com.tubevideodownloader.all.video.tube.download.fb.downloader.services;
...
import com.tubevideodownloader.all.video.tube.download.fb.downloader.activities.MainActivity;
import com.tubevideodownloader.all.video.tube.download.fb.downloader.fragments.DownloadMainFragment;
import com.tubevideodownloader.all.video.tube.download.fb.downloader.utils.MyClipboardManager;
...
//        }
    ...
    private PendingIntent buildPendingIntent(String action) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
            ...
            restartServicePendingIntent = PendingIntent.getBroadcast(getApplicationContext(), 1, i, PendingIntent.FLAG_ONE_SHOT);

...
import com.tubevideodownloader.all.video.tube.download.fb.downloader.databinding.ActivityMainBinding
import com.tubevideodownloader.all.video.tube.download.fb.downloader.extraFeatures.ExtraFeaturesFragment
import com.tubevideodownloader.all.video.tube.download.fb.downloader.fragments.DownloadMainFragment
...
import com.tubevideodownloader.all.video.tube.download.fb.downloader.statussaver.StatusSaverMainFragOld
import com.tubevideodownloader.all.video.tube.download.fb.downloader.statussaver.StatusSaverMainFragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            if (SDK_INT >= 33) {
                ...
                if (!areNotificationsEnabled) showNotificationPermissionRationale()
            } else {
    ...
    private fun showBottomSheetExitDialog() {
        try {
            ...
            if (Constants.show_Ads && !BuildConfig.ISPRO && nn == "nnn") {
                ...
                LoadAdTask(this@MainActivity, frameAd).execute()
            } else {

...
import com.tubevideodownloader.all.video.tube.download.fb.downloader.databinding.ActivityGalleryBinding;
import com.tubevideodownloader.all.video.tube.download.fb.downloader.fragments.GalleryAudiosFragment;
import com.tubevideodownloader.all.video.tube.download.fb.downloader.fragments.GalleryImagesFragment;
import com.tubevideodownloader.all.video.tube.download.fb.downloader.fragments.GalleryStatusSaver;
import com.tubevideodownloader.all.video.tube.download.fb.downloader.fragments.GalleryVideosFragment;
...
public class GalleryActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            final MyAdapter adapter = new MyAdapter(getSupportFragmentManager(), getLifecycle(), 4);

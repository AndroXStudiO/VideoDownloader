...
import com.tubevideodownloader.all.video.tube.download.fb.downloader.activities.newUi.MainActivityNewUi;
import com.tubevideodownloader.all.video.tube.download.fb.downloader.databinding.ActivitySplashScreenBinding;
import com.tubevideodownloader.all.video.tube.download.fb.downloader.models.adminpanel.AdId;
import com.tubevideodownloader.all.video.tube.download.fb.downloader.models.adminpanel.AppSettings;
import com.tubevideodownloader.all.video.tube.download.fb.downloader.models.adminpanel.Setting;
import com.tubevideodownloader.all.video.tube.download.fb.downloader.models.adminpanel.SocialMedia;
...
public class SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (com.tubevideodownloader.all.video.tube.download.fb.downloader.BuildConfig.ISPRO) {
...
//                    System.out.println("mysjdjhdjkh " + iUtils.myinstawebTempCookies);
    ...
    private void updateYoutubeDL() {
        ...
        Disposable disposable = Observable.fromCallable(() -> YoutubeDL.getInstance().updateYoutubeDL(this, YoutubeDL.UpdateChannel._NIGHTLY))
                    ...
                    switch (status) {
                        case DONE:
                            if (BuildConfig.DEBUG) {
                                ...
                                Toast.makeText(SplashScreen.this, "Api Update successful", Toast.LENGTH_LONG).show();
                            }
                            break;
                        case ALREADY_UP_TO_DATE:
                            if (BuildConfig.DEBUG) {
                                Log.e("SplashScreen", "Already up to date " + YoutubeDL.getInstance().versionName(this));
...
//                            Toast.makeText(SplashScreen.this, status.toString(), Toast.LENGTH_LONG).show();
                    ...
                    if (BuildConfig.DEBUG) {
                        ...
                        Toast.makeText(SplashScreen.this, "update failed", Toast.LENGTH_LONG).show();
                    }
                });
